...
if __name__ == "__main__":
    ...
    global_descriptors = extract_features.old_main(retrieval_conf, query_images, feature_path=globals_features, overwrite=True)
    # pdb.set_trace()
    #
    end_time = time.time()
    ...
    pairs_from_retrieval.main(
        global_descriptors, loc_pairs, num_matched=10, db_prefix="IMG", query_prefix="query"
    )
    # pdb.set_trace()
