...
from hloc.pipelines.Cambridge.utils import create_query_list_with_fixed_intrinsics, evaluate,create_query_list_with_fixed_intrinsics_use_imagedir,create_query_list_with_fixed_intrinsics_one_image,create_query_list_with_another_intrinsics_one_image
...
for one_query_image in all_query_images:
    ...
    features = extract_features.main(feature_conf, query_images, feature_path=features, overwrite=True,image_list=[one_query_image],
                                     model=feature_model)
    end_time1 = time.time()
    ...
    global_descriptors = extract_features.main(retrieval_conf, query_images, feature_path=globals_features,image_list=[one_query_image],
